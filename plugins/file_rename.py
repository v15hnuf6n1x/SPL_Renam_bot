...
async def doc(bot, update):
    ...
    try:
        ...
        return await update.message.edit(f"📣Something went wrong, can't able to set Prefix or Suffix ☹️ \n\n📮Contact My Admin -> @c0nt4ct_bot\nError: {e}")
