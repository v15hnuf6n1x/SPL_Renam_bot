...
class Database:
    ...
    def new_user(self, id):
        return dict(
            ...
            suffix=None,
            metadata=False,
            metadata_code=""" -map 0 -c:s copy -c:a copy -c:v copy -metadata title="Enc by @A1PHER Telegram" -metadata author="Enco by @A1PHER Telegram" -metadata:s:s title="Subtitled By :- @A1PHER Telegram" -metadata:s:a title="Enco by@A1PHER Telegram" -metadata:s:v title="Enco by @A1PHER Telegram" """
        )
